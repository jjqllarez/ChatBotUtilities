...
class CapitalMotorsCotizacion extends HTMLElement {
  ...
  _formatDireccion(direccion, maxChars = 45) {
    if (!direccion) return '';
  ...
  render() {
    ...
    const styles = `
      * { margin:0; padding:0; box-sizing:border-box; }
      ...
      .header-info p { font-size: 8px; margin: 1px auto; text-transform: uppercase; max-width: 360px; word-break: break-word; line-height: 1.3; }
        ...
        <div class="content-flow">
          <div class="header-container">
            ...
            <div class="header-info">
              ...
              <p>R.I.F.: ${this._socioComercial.rif || 'N/A'}</p><p class="header-dir">${this._formatDireccion(this._socioComercial.direccion, 45)}</p><p>TLF. ${this._socioComercial.telefono || ''} &nbsp;|&nbsp; ${this._socioComercial.correo || ''}</p>
            </div>
